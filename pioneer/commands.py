...
models = {
    'ALL': [
        'general.pqls',
        'general.settings.speakersystem',
        'general.settings.xcurve',
        'general.settings.hdmi',
    ...
    'SC-LX87': [
        'general.amp',
        'general.settings.surroundposition',
        'general.settings.xover',
...
commands = {
    'general': {
        ...
        'pqls': {
            ...
            'write': True,
            'read_cmd': '?PQ',
            'write_cmd': '{RAW_VALUE:01}PQ',
            'item_type': 'bool',
            'dev_datatype': 'PioBool',
            'reply_pattern': r'^PQ(\d)',
        },
        'dimmer': {
            'read': True,
            'write': True,
            'write_cmd': '{RAW_VALUE}SAA',
            'cmd_settings': {'force_min': 0, 'force_max': 3},
            'item_type': 'num',
            'dev_datatype': 'str',
            'reply_pattern': r'^SAA(\d)',
            'item_attrs': {'attributes': {'remark': '0 = very bright, 1 = bright, 2 = dark, 3 = off'}},
        },
        'sleep': {
            'read': True,
            'write': True,
            ...
            'write_cmd': '{VALUE}SAB',
            'item_type': 'num',
            'dev_datatype': 'PioSleep',
            'reply_pattern': r'^SAB(\d{3})',
            'item_attrs': {'attributes': {'remark': '0 = off, 30 = 30 minutes, 60 = 60 minutes, 90 = 90 minutes'}},
        },
        'amp': {
            'read': True,
            'write': True,
            ...
            'item_type': 'str',
            'dev_datatype': 'str',
            'reply_pattern': r'^SAC{LOOKUP}',
            'lookup': 'AMP',
            'item_attrs': {'attributes': {'remark': '0 = AMP, 1 = THR'}, 'lookup_item': True},
        },
        'multizone': {
            'read': True,
            'write': True,
            'write_cmd': 'ZZ',
            'item_type': 'bool',
            'dev_datatype': 'PioOnoff',
            'reply_pattern': r'^(?:APR|BPR|ZEP)(\d{1})',
        },
        'settings': {
            'language': {
                'read': True,
            ...
            'name': {
                ...
                'write_cmd': '{VALUE}SSO',
                'item_type': 'str',
                'dev_datatype': 'PioName',
                'reply_pattern': r'^SSO(?:\d{2})"(.*)"$',
                'item_attrs': {'initial': True},
            },
            'speakersystem': {
                'read': True,
                ...
                'item_type': 'str',
                'dev_datatype': 'raw',
                'reply_pattern': r'^SSF{LOOKUP}',
                'lookup': 'SPEAKERSYSTEM',
                'item_attrs': {'lookup_item': True, 'initial': True},
            },
            'surroundposition': {
                'read': True,
                'write': True,
                ...
                'item_type': 'str',
                'dev_datatype': 'raw',
                'reply_pattern': r'^SSP{LOOKUP}',
                'lookup': 'SURROUNDPOSITION',
                'item_attrs': {'lookup_item': True, 'initial': True},
            },
            'xover': {
                'read': True,
            ...
            'loudness': {
                ...
                'write': True,
                'read_cmd': '?SSU',
                'write_cmd': '{RAW_VALUE:01}SSU',
                'item_type': 'bool',
                'dev_datatype': 'PioBool',
                'reply_pattern': r'^SSU(\d{1})',
                'item_attrs': {'initial': True},
            },
            'initialvolume': {
                'read': True,
                ...
                'write_cmd': '{VALUE}SUC',
                'item_type': 'num',
                'dev_datatype': 'PioInitVol',
                'reply_pattern': r'^SUC(\d{3})',
                'item_attrs': {'initial': True},
            },
            'mutelevel': {
                'read': True,
            ...
            'hdmi': {
                'hdzone': {
                    ...
                    'write': True,
                    'read_cmd': '?SVZ',
                    'write_cmd': '{RAW_VALUE:01}SVZ',
                    'item_type': 'bool',
                    'dev_datatype': 'PioBool',
                    'reply_pattern': r'^SVZ(\d{1})',
                    'item_attrs': {'initial': True},
                },
                'control': {
                    'read': True,
                    'write': True,
                    'read_cmd': '?STQ',
                    'write_cmd': '{RAW_VALUE:01}STQ',
                    'item_type': 'bool',
                    'dev_datatype': 'PioBool',
                    'reply_pattern': r'^STQ(\d{1})',
                    'item_attrs': {'initial': True},
                },
                'controlmode': {
                    'read': True,
                    'write': True,
                    'read_cmd': '?STR',
                    'write_cmd': '{RAW_VALUE:01}STR',
                    'item_type': 'bool',
                    'dev_datatype': 'PioBool',
                    'reply_pattern': r'^STR(\d{1})',
                    'item_attrs': {'initial': True},
                },
                'arc': {
                    'read': True,
                    'write': True,
                    'read_cmd': '?STT',
                    'write_cmd': '{RAW_VALUE:01}STT',
                    'item_type': 'bool',
                    'dev_datatype': 'PioBool',
                    'reply_pattern': r'^STT(\d{1})',
                    'item_attrs': {'initial': True},
                },
                'standbythrough': {
                    'read': True,
                    ...
                    'item_type': 'str',
                    'dev_datatype': 'raw',
                    'reply_pattern': r'^STU{LOOKUP}',
                    'lookup': 'STANDBYTHROUGH',
                    'item_attrs': {'lookup_item': True, 'initial': True},
                },
            },
        },
    ...
    'zone1': {
        'control': {
            'power': {
                ...
                'item_type': 'bool',
                'dev_datatype': 'PioOnoff',
                'reply_pattern': r'^PWR(\d{1})',
                'item_attrs': {'item_template': 'power'},
            },
            'mute': {
                'read': True,
                'write': True,
                ...
                'item_type': 'bool',
                'dev_datatype': 'PioOnoff',
                'reply_pattern': r'^MUT(\d{1})',
            },
            'volume': {
                'read': True,
                'write': True,
                'read_cmd': '?V',
                'write_cmd': '{RAW_VALUE:03}VL',
                'item_type': 'num',
                'dev_datatype': 'str',
                'reply_pattern': r'^VOL(\d{3})',
                'cmd_settings': {'force_min': 0, 'valid_max': 185},
            },
        ...
        'settings': {
            'standby': {
                ...
                'write_cmd': '{VALUE}STY',
                'item_type': 'num',
                'dev_datatype': 'PioStandby',
                'reply_pattern': r'^STY(\d{4})',
                'item_attrs': {
                    'attributes': {'remark': '0 = OFF, 15 = 15 minutes, 30 = 30 minutes, 60 = 60 minutes'},
                    'initial': True,
                },
            },
            'sound': {
                'channel_level': {
                    'front_left': {
                        ...
                        'write_cmd': 'L__{VALUE}CLV',
                        'dev_datatype': 'PioChannelVol',
                    ...
                    'front_height_left': {
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'LH_{VALUE}CLV',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^CLVLH_(\d{2})',
                    },
                    'front_height_right': {
                        'read': True,
                        'write': True,
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'RH_{VALUE}CLV',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^CLVRH_(\d{2})',
                    },
                    'front_wide_left': {
                        'read': True,
                        'write': True,
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'LW_{VALUE}CLV',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^LWVSW_(\d{2})',
                    },
                    'front_wide_right': {
                        'read': True,
                        'write': True,
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'RW_{VALUE}CLV',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^RWVSW_(\d{2})',
                    },
                    'subwoofer': {
                        'read': True,
                        'write': True,
                ...
                'tone_control': {
                    'tone': {
                        ...
                        'read_cmd': '?TO',
                        'item_type': 'bool',
                        'write_cmd': '{RAW_VALUE:01}TO',
                        'dev_datatype': 'PioBool',
                        'reply_pattern': r'^TO(\d)',
                        'item_attrs': {'item_template': 'tone'},
                    },
                    'treble': {
                        'read': True,
                        'write': True,
                ...
                'general': {
                    ...
                    'dialog': {
                        ...
                        'read_cmd': '?ATH',
                        'write_cmd': '{VALUE}ATH',
                        'cmd_settings': {'force_min': 0, 'force_max': 5},
                        'item_type': 'num',
                        'dev_datatype': 'str',
                    ...
                    'listeningmode': {
                        ...
                        'item_type': 'str',
                        'dev_datatype': 'str',
                        'reply_pattern': r'^SR{LOOKUP}',
                        'lookup': 'LISTENINGMODE',
                        'item_attrs': {'lookup_item': True},
                    },
                    'playingmode': {
                        'read': True,
                    ...
                    'speakers': {
                        ...
                        'item_type': 'num',
                        'dev_datatype': 'str',
                        'cmd_settings': {'valid_list': [0, 1, 2, 3, 9]},
                        'write_cmd': '{RAW_VALUE:01}SPK',
                        'reply_pattern': r'^SPK(\d)',
                        'item_attrs': {'item_template': 'speakers'},
                    },
                },
            },
        },
    ...
    'zone2': {
        'control': {
            ...
            'mute': {
                ...
                'write_cmd': 'Z2M{VALUE}',
                'dev_datatype': 'PioOnoff',
                'reply_pattern': r'^Z2MUT(\d{1})',
            },
            'volume': {
                'read': True,
                'write': True,
                'read_cmd': '?ZV',
                'write_cmd': '{RAW_VALUE:02}ZV',
                'item_type': 'num',
                'dev_datatype': 'str',
                'reply_pattern': r'^ZV(\d{2})',
                'cmd_settings': {'force_min': 0, 'valid_max': 81},
            },
        ...
        'settings': {
            'standby': {
                ...
                'write_cmd': '{VALUE}STZ',
                'item_type': 'num',
                'dev_datatype': 'PioStandby2',
                'reply_pattern': r'^STZ(\d{4})',
                'item_attrs': {
                    'attributes': {
                        'remark': '0 = OFF, 0.5 = 30 minutes, 1 = 1 hour, 3 = 3 hours, 6 = 6 hours, 9 = 9 hours'
                    },
                    'initial': True,
                },
            },
            'sound': {
                'channel_level': {
                    'front_left': {
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'L__{VALUE}ZGE',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^ZGEL__(\d{2})',
                    },
                    'front_right': {
                        'read': True,
                        'write': True,
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'R__{VALUE}ZGE',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^ZGER__(\d{2})',
                    },
                },
                'tone_control': {
                    'tone': {
                        ...
                        'read_cmd': '?ZGA',
                        'item_type': 'bool',
                        'write_cmd': '{RAW_VALUE:01}ZGA',
                        'dev_datatype': 'PioBool',
                        'reply_pattern': r'^ZGA(\d)',
                        'item_attrs': {'item_template': 'tone'},
                    },
                    'treble': {
                        'read': True,
    ...
    'zone3': {
        'control': {
            'power': {
                ...
                'item_type': 'bool',
                'dev_datatype': 'PioOnoff',
                'reply_pattern': r'^BPR(\d{1})',
                'item_attrs': {
                    'item_template': 'power',
                    'attributes': {
                        'remark': 'For some receivers it might be necessary to change speakersystem to Zone 2 and hdzone for HDMI on.'
                    },
                },
            },
            'mute': {
                ...
                'write_cmd': 'Z3M{VALUE}',
                'dev_datatype': 'PioOnoff',
                'reply_pattern': r'^Z3MUT(\d{1})',
            },
            'volume': {
                'read': True,
                'write': True,
                'read_cmd': '?YV',
                'write_cmd': '{RAW_VALUE:02}YV',
                'item_type': 'num',
                'dev_datatype': 'str',
                'reply_pattern': r'^YV(\d{2})',
                'cmd_settings': {'force_min': 0, 'valid_max': 81},
            },
            ...
            'sound': {
                'channel_level': {
                    'front_left': {
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'L__{VALUE}ZHE',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^ZHEL__(\d{2})',
                    },
                    'front_right': {
                        'read': True,
                        'write': True,
                        ...
                        'item_type': 'num',
                        'cmd_settings': {'force_min': -12.0, 'valid_max': 12.0},
                        'write_cmd': 'R__{VALUE}ZHE',
                        'dev_datatype': 'PioChannelVol',
                        'reply_pattern': r'^ZHER__(\d{2})',
                    },
                }
            },
        },
...
lookups = {
    'ALL': {
        'ERROR': {'2': 'not available now', '3': 'invalid command', '4': 'command error', '6': 'parameter error'},
        'HDMIOUT': {
            '0': 'HDMI OUT 1+2 ON',
            '1': 'HDMI OUT 1 ON',
            '2': 'HDMI OUT 2 ON',
        ...
        'HDMIAUDIO': {'0': 'AMP', '1': 'THRU', '9': 'HDMI AUDIO (cyclic)'},
        'MUTELEVEL': {'0': 'Full', '1': '-40db', '2': '-20db'},
        'XOVER': {'0': '50Hz', '1': '80Hz', '2': '100Hz', '3': '150Hz', '4': '200Hz'},
        'XCURVE': {
            '0': 'OFF',
            '1': '-0.5db',
            '2': '-1.0db',
        ...
        'SURROUNDPOSITION': {'0': 'ON SIDE', '1': 'IN REAR'},
        'TONE': {
            '00': 6,
            '01': 5,
            '02': 4,
    ...
    'SC-LX87': {
        ...
        'INPUTHD': {'10': 'VIDEO 1 (VIDEO)', '35': 'HDMI 8'},
        'SPEAKERSYSTEM': {
            '10': '9.1ch FH/FW',
            '11': '7.1ch + Speaker B',
    ...
    'SC-LX77': {
        'INPUT': {'10': 'VIDEO 1(VIDEO)', '35': 'HDMI 8', '00': 'PHONO'},
        'INPUT2': {
            '26': 'NETWORK (cyclic)',
            '38': 'INTERNET RADIO',
            '44': 'MEDIA SERVER',
    ...
    'SC-LX57': {
        'INPUT': {'10': 'VIDEO 1(VIDEO)', '35': 'HDMI 8'},
        'INPUT2': {
            '10': 'VIDEO 1 (VIDEO)',
            '26': 'NETWORK (cyclic)',
            '38': 'INTERNET RADIO',
    ...
    'SC-2023': {
        'INPUT': {'10': 'VIDEO 1(VIDEO)', '41': 'PANDORA'},
        'INPUT2': {
            '26': 'NETWORK (cyclic)',
            '38': 'INTERNET RADIO',
            '41': 'PANDORA',
...
item_templates = {
    ...
    'tone': {'pioneer_read_initial': True, 'on_change': 'sh...read(True) if value else None'},
}

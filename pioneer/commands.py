...
commands = {
    'general': {
        ...
        'pqls': {'read': True, 'write': True, 'read_cmd': '?PQ', 'write_cmd': '{RAW_VALUE:01}PQ', 'item_type': 'bool', 'dev_datatype': 'PioBool', 'reply_pattern': r'^PQ(\d)'},
        ...
        'multizone': {'read': True, 'write': True, 'write_cmd': 'ZZ', 'item_type': 'bool', 'dev_datatype': 'PioOnoff', 'reply_pattern': r'^(?:APR|BPR|ZEP)(\d{1})'},
        'settings': {
            ...
            'xover': {'read': True, 'write': True, 'read_cmd': '?SSQ', 'write_cmd': '{VALUE}SSQ', 'item_type': 'str', 'dev_datatype': 'raw', 'reply_pattern': r'^SSQ{LOOKUP}', 'lookup': 'XOVER', 'item_attrs': {'lookup_item': True, 'initial': True}},
            'xcurve': {'read': True, 'write': True, 'read_cmd': '?SST', 'write_cmd': '{VALUE}SST', 'item_type': 'str', 'dev_datatype': 'raw', 'reply_pattern': r'^SST{LOOKUP}', 'lookup': 'XCURVE', 'item_attrs': {'lookup_item': True, 'initial': True}},
            'loudness': {'read': True, 'write': True, 'read_cmd': '?SSU', 'write_cmd': '{RAW_VALUE:01}SSU', 'item_type': 'bool', 'dev_datatype': 'PioBool', 'reply_pattern': r'^SSU(\d{1})', 'item_attrs': {'initial': True}},
    ...
    'tuner': {
        'tunerpreset': {'read': True, 'write': True, 'read_cmd': '?PR', 'item_type': 'str', 'write_cmd': '{RAW_VALUE}PR', 'dev_datatype': 'str', 'reply_pattern': r'^PR([A-Ga-g]\d{2})'},
        ...
        'title': {'read': True, 'write': False, 'item_type': 'str', 'dev_datatype': 'str', 'read_cmd': '?GAH', 'reply_pattern': '^GEH01020"(.*)"$'},
        'genre': {'read': True, 'write': False, 'item_type': 'str', 'dev_datatype': 'str', 'read_cmd': '?GAH', 'reply_pattern': '^GEH05024"(.*)"$', 'item_attrs': {'read_group_levels': 0}},
        'station': {'read': True, 'write': False, 'item_type': 'str', 'dev_datatype': 'str', 'read_cmd': '?GAH', 'reply_pattern': '^GEH04022"(.*)"$', 'item_attrs': {'read_group_levels': 0}}
    },
    'zone1': {
        'control': {
            'power': {'read': True, 'write': True, 'read_cmd': '?P', 'write_cmd': 'P{VALUE}', 'item_type': 'bool', 'dev_datatype': 'PioOnoff', 'reply_pattern': r'^PWR(\d{1})', 'item_attrs': {'item_template': 'power'}},
            'mute': {'read': True, 'write': True, 'read_cmd': '?M', 'write_cmd': 'M{VALUE}', 'item_type': 'bool', 'dev_datatype': 'PioOnoff', 'reply_pattern': r'^MUT(\d{1})'},
        ...
        'settings': {
            ...
            'sound': {
                ...
                'tone_control': {
                    'tone': {'read': True, 'write': True, 'read_cmd': '?TO', 'item_type': 'bool', 'write_cmd': '{RAW_VALUE:01}TO', 'dev_datatype': 'PioBool', 'reply_pattern': r'^TO(\d)', 'item_attrs': {'item_template': 'tone'}},
                ...
                'general': {
                    ...
                    'playingmode': {'read': True, 'write': False, 'read_cmd': '?L', 'item_type': 'str', 'dev_datatype': 'str', 'reply_pattern': r'^LM{LOOKUP}', 'lookup': 'PLAYINGMODE'},
    ...
    'zone2': {
        'control': {
            'power': {'read': True, 'write': True, 'read_cmd': '?AP', 'write_cmd': 'AP{VALUE}', 'item_type': 'bool', 'dev_datatype': 'PioOnoff', 'reply_pattern': r'^APR(\d{1})', 'item_attrs': {'item_template': 'power'}},
            'mute': {'read': True, 'write': True, 'read_cmd': '?Z2M', 'item_type': 'bool', 'write_cmd': 'Z2M{VALUE}', 'dev_datatype': 'PioOnoff', 'reply_pattern': r'^Z2MUT(\d{1})'},
        ...
        'settings': {
            ...
            'sound': {
                ...
                'tone_control': {
                    'tone': {'read': True, 'write': True, 'read_cmd': '?ZGA', 'item_type': 'bool', 'write_cmd': '{RAW_VALUE:01}ZGA', 'dev_datatype': 'PioBool', 'reply_pattern': r'^ZGA(\d)', 'item_attrs': {'item_template': 'tone'}},
    ...
    'hdzone': {
        'control': {
            'power': {'read': True, 'write': True, 'read_cmd': '?ZEP', 'write_cmd': 'ZE{VALUE}', 'item_type': 'bool', 'dev_datatype': 'PioOnoff', 'reply_pattern': r'^ZEP(\d{1})'},

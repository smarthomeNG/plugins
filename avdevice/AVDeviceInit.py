    ...
    def get_items(self, zone):
        ...
        for item in self._items[zone]:
            ...
            if not item == 'dependson':
                try:
                    sortedlist.append(_result.property.name)
                except Exception:
                            ...
                            finaldepend['Slave_function'][zone].update(
                                {entry:
                                 [{'Item': item,
                                   ...
                                   'Function': depend_function}]})
                        try:
                            finaldepend['Slave_item'][zone][self._items[zone][entry].get('Item').property.name].append(
                                {'Item': item,
                                 'Dependvalue': depend_value,
                                 'Compare': depend_compare,
                                 'Zone': depend_zone,
                            ...
                            finaldepend['Slave_item'][zone].update(
                                {self._items[zone][entry].get('Item').property.name:
                                 [{'Item': item,
                                   'Dependvalue': depend_value,
                                   'Compare': depend_compare,
                                   'Zone': depend_zone,

...
Tested with Pioneer and Denon AV receivers and Epson projector
...
You can use two special avdevice attributes if you want:
...
Each line holds one specific command that should be sent to the device. You also specify the zone, the query command, response command, etc. You can comment out lines by placing a "#" in front of the line.

...
commands = {
    ...
    'player': {
        'control': {
            ...
            'playmode': {'read': True, 'write': True, 'read_cmd': '{CUSTOM_ATTR1} mode ?', 'item_type': 'str', 'write_cmd': '{CUSTOM_ATTR1} mode {VALUE}', 'dev_datatype': 'SqueezePlayMode', 'cmd_settings': {'valid_list_ci': ['PLAY', 'PAUSE', 'STOP']}, 'reply_pattern': r'{CUSTOM_PATTERN1} (?:mode|playlist) (play$|pause\s?\d?|stop$)', 'item_attrs': {'initial': True, 'enforce': True}},

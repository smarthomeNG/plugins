...
commands = {
    ...
    'player': {
        ...
        'playlist': {
            ...
            'count': {'read': True, 'write': False, 'read_cmd': '{CUSTOM_ATTR1} playlistcontrol ?', 'item_type': 'num', 'dev_datatype': 'str', 'reply_pattern': r'{CUSTOM_ATTR1} playlistcontrol cmd:load .* count:(.*)'},

...
class TestImplicitRevalidation(unittest.TestCase):
    ...
    def _open_gap(self, mgr, item, gap_start_ts, prior_value=250.0, prior_start_ts=1000):
    ...
    def _simulate_update_item(self, mgr, gap_items, item, update_ts, new_value):
        """
    ...
    def test_gap_duration_uses_gap_start_not_prev_change(self):
        ...
        self._open_gap(mgr, item, gap_start, prior_value=250.0, prior_start_ts=prior_start)
    ...
    def test_no_stale_prev_value_emitted_during_gap(self):
        ...
        self._open_gap(mgr, item, gap_start_ts=1500, prior_value=250.0, prior_start_ts=1000)
        gap_items[item] = 1500

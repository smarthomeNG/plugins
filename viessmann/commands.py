...
commandset = {
    'V200KO1B': {
        ...
        'getSammelstoerung': { 'addr': '0a82', 'len': 1, 'type': 'read', 'result': 'bool', 'signage': 'unsigned', 'valuetransform': 'non' }, #Sammelstörung
        ...
        'setBrenner-Betriebsstunden': { 'addr': '08a7', 'len': 4, 'type': 'write', 'valuetransform': 'div3600', 'min_value': 0, 'max_value': 1193045 }, #Brenner-Betriebsstunden
        ...
        'setFerien_Abreisetag_M2': { 'addr': '3309', 'len': 4, 'type': 'write', 'valuetransform': 'non' }, #Ferien Abreisetag M2
        'setFerien_Rückreisetag_M2': { 'addr': '3311', 'len': 4, 'type': 'write', 'valuetransform': 'non' }, #Ferien Rückreisetag M2
        ...
        'setFerienprogramm_M2': { 'addr': '3535', 'len': 1, 'type': 'write', 'valuetransform': 'non' }, #Ferienprogramm M2
        'setExterne_Betriebsartenumschaltung_M2': { 'addr': '3549', 'len': 1, 'type': 'write', 'valuetransform': 'non', 'min_value': 0, 'max_value': 4 }, #Externe Betriebsartenumschaltung M2

    ...
    'V200WO1C': {
        ...
        'Heizkreis': {
            'Temperatur': {
                ...
                'Vorlauf': {
                    'Ist':             {'read': True, 'write': False, 'opcode': '0105', 'reply_pattern': '*', 'item_type': 'num',  'dev_datatype': 'V', 'params': {'value': 'VAL', 'mult': 10, 'signed': True, 'len': 2}, 'item_attrs': {'cyclic': True}},     # getTempSekVL -- Information - Heizkreis HK1: Vorlauftemperatur Sekundaer 1 (0..95)
                ...
                'Ruecklauf': {
                    'Ist':             {'read': True, 'write': False, 'opcode': '0106', 'reply_pattern': '*', 'item_type': 'num',  'dev_datatype': 'V', 'params': {'value': 'VAL', 'mult': 10, 'signed': True, 'len': 2}, 'item_attrs': {'cyclic': True}},     # getTempSekRL -- Diagnose - Anlagenuebersicht: Ruecklauftemperatur Sekundaer 1 (0..95)
        ...
        'Warmwasser': {
            'Ist':                     {'read': True, 'write': False, 'opcode': '010d', 'reply_pattern': '*', 'item_type': 'num',  'dev_datatype': 'V', 'params': {'value': 'VAL', 'mult': 10, 'signed': True, 'len': 2}, 'item_attrs': {'cyclic': True}},     # getTempWWIstOben -- Information - Warmwasser: Warmwassertemperatur oben (0..95)

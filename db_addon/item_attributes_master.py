...
ITEM_ATTRIBUTES = {
    'db_addon_fct': {
        ...
        'verbrauch_heute_minus1':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Verbrauch gestern (heute -1 Tag) (Differenz zwischen Wert am Ende des gestrigen Tages und dem Wert am Ende des Tages danach)'},
        ...
        'verbrauch_heute_minus4':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Verbrauch heute -4 Tage'},
        ...
        'verbrauch_woche_minus4':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'weekly',    'params': False,  'description': 'Verbrauch aktuelle Woche -4 Wochen'},
        'verbrauch_monat_minus1':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Verbrauch Vormonat (aktueller Monat -1)'},
        'verbrauch_monat_minus2':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Verbrauch aktueller Monat -2 Monate'},
        'verbrauch_monat_minus3':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Verbrauch aktueller Monat -3 Monate'},
        'verbrauch_monat_minus4':                  {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Verbrauch aktueller Monat -4 Monate'},
        'verbrauch_monat_minus12':                 {'cat': 'verbrauch',     'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Verbrauch aktueller Monat -12 Monate'},
        ...
        'verbrauch_jahreszeitraum_minus1':         {'cat': 'verbrauch',     'sub_cat': 'jahrzeit',   'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Verbrauch seit dem 1.1. bis zum heutigen Tag des Vorjahres'},
        'verbrauch_jahreszeitraum_minus2':         {'cat': 'verbrauch',     'sub_cat': 'jahrzeit',   'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Verbrauch seit dem 1.1. bis zum heutigen Tag vor 2 Jahren'},
        'verbrauch_jahreszeitraum_minus3':         {'cat': 'verbrauch',     'sub_cat': 'jahrzeit',   'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Verbrauch seit dem 1.1. bis zum heutigen Tag vor 3 Jahren'},
        ...
        'zaehlerstand_monat_minus1':               {'cat': 'zaehler',       'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Zählerstand / Wert am Ende des letzten Monates (aktueller Monat -1 Monat)'},
        'zaehlerstand_monat_minus2':               {'cat': 'zaehler',       'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Zählerstand / Wert am Ende des vorletzten Monates (aktueller Monat -2 Monate)'},
        'zaehlerstand_monat_minus3':               {'cat': 'zaehler',       'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Zählerstand / Wert am Ende des aktuellen Monats -3 Monate'},
        'zaehlerstand_jahr_minus1':                {'cat': 'zaehler',       'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'yearly',    'params': False,  'description': 'Zählerstand / Wert am Ende des letzten Jahres (aktuelles Jahr -1 Jahr)'},
        'zaehlerstand_jahr_minus2':                {'cat': 'zaehler',       'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'yearly',    'params': False,  'description': 'Zählerstand / Wert am Ende des vorletzten Jahres (aktuelles Jahr -2 Jahre)'},
        'zaehlerstand_jahr_minus3':                {'cat': 'zaehler',       'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'yearly',    'params': False,  'description': 'Zählerstand / Wert am Ende des aktuellen Jahres -3 Jahre'},
        'minmax_last_24h_min':                     {'cat': 'wertehistorie', 'sub_cat': 'last',       'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'minimaler Wert der letzten 24h'},
        'minmax_last_24h_max':                     {'cat': 'wertehistorie', 'sub_cat': 'last',       'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'maximaler Wert der letzten 24h'},
        'minmax_last_24h_avg':                     {'cat': 'wertehistorie', 'sub_cat': 'last',       'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'durchschnittlicher Wert der letzten 24h'},
        'minmax_last_7d_min':                      {'cat': 'wertehistorie', 'sub_cat': 'last',       'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'minimaler Wert der letzten 7 Tage'},
        'minmax_last_7d_max':                      {'cat': 'wertehistorie', 'sub_cat': 'last',       'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'maximaler Wert der letzten 7 Tage'},
        ...
        'minmax_heute_minus2_min':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Minimalwert vorgestern (heute -2 Tage)'},
        'minmax_heute_minus2_max':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Maximalwert vorgestern (heute -2 Tage)'},
        'minmax_heute_minus2_avg':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'daily',     'params': False,  'description': 'Durchschnittswert vorgestern (heute -2 Tage)'},
        ...
        'minmax_woche_minus1_max':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'weekly',    'params': False,  'description': 'Maximalwert Vorwoche (aktuelle Woche -1)'},
        'minmax_woche_minus1_avg':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'weekly',    'params': False,  'description': 'Durchschnittswert Vorwoche (aktuelle Woche -1)'},
        'minmax_woche_minus2_min':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'weekly',    'params': False,  'description': 'Minimalwert aktuelle Woche -2 Wochen'},
        'minmax_woche_minus2_max':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'weekly',    'params': False,  'description': 'Maximalwert aktuelle Woche -2 Wochen'},
        'minmax_woche_minus2_avg':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'weekly',    'params': False,  'description': 'Durchschnittswert aktuelle Woche -2 Wochen'},
        'minmax_monat_min':                        {'cat': 'wertehistorie', 'sub_cat': 'onchange',   'item_type': 'num',   'calc': 'onchange',  'params': False,  'description': 'Minimalwert seit Monatsbeginn'},
        'minmax_monat_max':                        {'cat': 'wertehistorie', 'sub_cat': 'onchange',   'item_type': 'num',   'calc': 'onchange',  'params': False,  'description': 'Maximalwert seit Monatsbeginn'},
        'minmax_monat_minus1_min':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Minimalwert Vormonat (aktueller Monat -1)'},
        'minmax_monat_minus1_max':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Maximalwert Vormonat (aktueller Monat -1)'},
        'minmax_monat_minus1_avg':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Durchschnittswert Vormonat (aktueller Monat -1)'},
        'minmax_monat_minus2_min':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Minimalwert aktueller Monat -2 Monate'},
        'minmax_monat_minus2_max':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Maximalwert aktueller Monat -2 Monate'},
        'minmax_monat_minus2_avg':                 {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'monthly',   'params': False,  'description': 'Durchschnittswert aktueller Monat -2 Monate'},
        'minmax_jahr_min':                         {'cat': 'wertehistorie', 'sub_cat': 'onchange',   'item_type': 'num',   'calc': 'onchange',  'params': False,  'description': 'Minimalwert seit Jahresbeginn'},
        'minmax_jahr_max':                         {'cat': 'wertehistorie', 'sub_cat': 'onchange',   'item_type': 'num',   'calc': 'onchange',  'params': False,  'description': 'Maximalwert seit Jahresbeginn'},
        'minmax_jahr_minus1_min':                  {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'yearly',    'params': False,  'description': 'Minimalwert Vorjahr (aktuelles Jahr -1 Jahr)'},
        'minmax_jahr_minus1_max':                  {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'yearly',    'params': False,  'description': 'Maximalwert Vorjahr (aktuelles Jahr -1 Jahr)'},
        'minmax_jahr_minus1_avg':                  {'cat': 'wertehistorie', 'sub_cat': 'timeframe',  'item_type': 'num',   'calc': 'yearly',    'params': False,  'description': 'Durchschnittswert Vorjahr (aktuelles Jahr -1 Jahr)'},
        'tagesmitteltemperatur_heute':             {'cat': 'tagesmittel',   'sub_cat': 'onchange',   'item_type': 'num',   'calc': 'onchange',  'params': False,  'description': 'Tagesmitteltemperatur heute'},
        ...
        'serie_minmax_woche_min_30w':              {'cat': 'serie',         'sub_cat': 'minmax',     'item_type': 'list',  'calc': 'weekly',    'params': False,  'description': 'wöchentlicher Minimalwert der letzten 30 Wochen (gleitend)'},
        'serie_minmax_woche_max_30w':              {'cat': 'serie',         'sub_cat': 'minmax',     'item_type': 'list',  'calc': 'weekly',    'params': False,  'description': 'wöchentlicher Maximalwert der letzten 30 Wochen (gleitend)'},
        'serie_minmax_woche_avg_30w':              {'cat': 'serie',         'sub_cat': 'minmax',     'item_type': 'list',  'calc': 'weekly',    'params': False,  'description': 'wöchentlicher Mittelwert der letzten 30 Wochen (gleitend)'},
        'serie_minmax_tag_min_30d':                {'cat': 'serie',         'sub_cat': 'minmax',     'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'täglicher Minimalwert der letzten 30 Tage (gleitend)'},
        'serie_minmax_tag_max_30d':                {'cat': 'serie',         'sub_cat': 'minmax',     'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'täglicher Maximalwert der letzten 30 Tage (gleitend)'},
        'serie_minmax_tag_avg_30d':                {'cat': 'serie',         'sub_cat': 'minmax',     'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'täglicher Mittelwert der letzten 30 Tage (gleitend)'},
        'serie_verbrauch_tag_30d':                 {'cat': 'serie',         'sub_cat': 'verbrauch',  'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'Verbrauch pro Tag der letzten 30 Tage'},
        'serie_verbrauch_woche_30w':               {'cat': 'serie',         'sub_cat': 'verbrauch',  'item_type': 'list',  'calc': 'weekly',    'params': False,  'description': 'Verbrauch pro Woche der letzten 30 Wochen'},
        'serie_verbrauch_monat_18m':               {'cat': 'serie',         'sub_cat': 'verbrauch',  'item_type': 'list',  'calc': 'monthly',   'params': False,  'description': 'Verbrauch pro Monat der letzten 18 Monate'},
        'serie_zaehlerstand_tag_30d':              {'cat': 'serie',         'sub_cat': 'zaehler',    'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'Zählerstand am Tagesende der letzten 30 Tage'},
        'serie_zaehlerstand_woche_30w':            {'cat': 'serie',         'sub_cat': 'zaehler',    'item_type': 'list',  'calc': 'weekly',    'params': False,  'description': 'Zählerstand am Wochenende der letzten 30 Wochen'},
        'serie_zaehlerstand_monat_18m':            {'cat': 'serie',         'sub_cat': 'zaehler',    'item_type': 'list',  'calc': 'monthly',   'params': False,  'description': 'Zählerstand am Monatsende der letzten 18 Monate'},
        'serie_waermesumme_monat_24m':             {'cat': 'serie',         'sub_cat': 'summe',      'item_type': 'list',  'calc': 'monthly',   'params': False,  'description': 'monatliche Wärmesumme der letzten 24 Monate'},
        'serie_kaeltesumme_monat_24m':             {'cat': 'serie',         'sub_cat': 'summe',      'item_type': 'list',  'calc': 'monthly',   'params': False,  'description': 'monatliche Kältesumme der letzten 24 Monate'},
        'serie_tagesmittelwert_0d':                {'cat': 'serie',         'sub_cat': 'mittel_d',   'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'Tagesmittelwert für den aktuellen Tag'},
        'serie_tagesmittelwert_stunde_0d':         {'cat': 'serie',         'sub_cat': 'mittel_h',   'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'Stundenmittelwert für den aktuellen Tag'},
        'serie_tagesmittelwert_stunde_30_0d':      {'cat': 'serie',         'sub_cat': 'mittel_h1',  'item_type': 'list',  'calc': 'daily',     'params': False,  'description': 'Stundenmittelwert für den aktuellen Tag'},
        ...
        'verbrauch':                               {'cat': 'complex',       'sub_cat': None,         'item_type': 'num',   'calc': 'timeframe', 'params': True,   'description': 'Berechnet einen Verbrauchswert für einen bestimmen Zeitraum:  db_addon_params: (timeframe=mandatory, start=mandatory end=mandatory)'},
        'zaehlerstand':                            {'cat': 'complex',       'sub_cat': None,         'item_type': 'num',   'calc': 'timeframe', 'params': True,   'description': 'Berechnet einen Zählerstand für einen bestimmen Zeitpunkt:  db_addon_params: (timeframe=mandatory, start=mandatory)'},
    },
    'db_addon_info': {

class DelayModel:
    ...
    intent_pending = property(__get_intent_pending, __set_intent_pending)
    ...
    intended_target_state = property(__get_intended_target_state, __set_intended_target_state)

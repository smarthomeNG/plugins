...
class Inverter:
    ...
    def __read_u16_2(self, adr_dec):
        result = self.client.read_holding_registers(adr_dec, 2, slave=71)
        u16_2_value = BinaryPayloadDecoder.fromRegisters(
            result.registers, byteorder=Endian.BIG, wordorder=Endian.LITTLE
        )
    ...
    def __read_str08(self, adr_dec):
        ...
        str08_value = BinaryPayloadDecoder.fromRegisters(
            result.registers, byteorder=Endian.BIG, wordorder=Endian.LITTLE
        )
    ...
    __descriptionRow = [
        ...
        'Reactive power phase 1 (powermeter)',
        'Apparent power phase 1 (powermeter)',
        'Voltage phase 1 (powermeter)',
        'Current phase 2 (powermeter)',
        'Active power phase 2 (powermeter)',
        'Reactive power phase 2 (powermeter)',
        'Apparent power phase 2 (powermeter)',
        'Voltage phase 2 (powermeter)',
        'Current phase 3 (powermeter)',
        'Active power phase 3 (powermeter)',
        'Reactive power phase 3 (powermeter)',
        'Apparent power phase 3 (powermeter)',
        ...
        'Battery actual SOC',
        'Firmware Maincontroller (MC)',
        'Battery Model ID',
        'Work Capacity',
        'Inverter Max Power',
        'Inverter Generation Power (actual)',
        'Generation Energy',
        ...
        'Temperature of controller PCB',
        'Inverter Network Name',
        'Inverter article number',
        'Inverter serial number',
        'Software-Version Maincontroller (MC)',

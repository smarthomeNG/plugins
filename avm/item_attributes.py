...
ALL_ATTRIBUTES_SUPPORTED_BY_REPEATER = ['uptime', 'serial_number', 'software_version', 'hardware_version', 'manufacturer', 'product_class', 'manufacturer_oui', 'model_name', 'description', 'device_log', 'security_port', 'reboot', 'wlanconfig', 'wlanconfig_ssid', 'wlan_guest_time_remaining', 'wlan_associates', 'wps_active', 'wps_status', 'wps_mode', 'wlan_total_associates', 'hosts_count', 'hosts_info', 'mesh_topology', 'number_of_hosts', 'hosts_url', 'mesh_url', 'network_device', 'device_ip', 'device_connection_type', 'device_hostname', 'connection_status', 'is_host_active', 'host_info']
ALL_ATTRIBUTES_WRITEABLE = ['reboot', 'set_target_temperature', 'set_window_open', 'set_hkr_boost', 'set_simpleonoff', 'set_level', 'set_levelpercentage', 'set_hue', 'set_saturation', 'set_colortemperature', 'switch_toggle', 'tam', 'wlanconfig', 'wps_active', 'deflection_enable', 'aha_device', 'target_temperature', 'window_open', 'hkr_boost', 'hkr_mode_str', 'hkr_mode', 'simpleonoff', 'level', 'levelpercentage', 'hue', 'saturation', 'unmapped_hue', 'unmapped_saturation', 'color', 'hsv', 'colortemperature', 'switch_state']
...
AHA_ATTRIBUTES = ['device_id', 'manufacturer', 'product_name', 'fw_version', 'connected', 'device_name', 'tx_busy', 'device_functions', 'set_target_temperature', 'target_temperature', 'current_temperature', 'temperature_reduced', 'temperature_comfort', 'temperature_offset', 'set_window_open', 'window_open', 'windowopenactiveendtime', 'set_hkr_boost', 'hkr_boost', 'hkr_mode_str', 'hkr_mode', 'boost_active', 'boostactiveendtime', 'summer_active', 'holiday_active', 'battery_low', 'battery_level', 'lock', 'device_lock', 'errorcode', 'set_simpleonoff', 'simpleonoff', 'set_level', 'level', 'set_levelpercentage', 'levelpercentage', 'set_hue', 'hue', 'set_saturation', 'saturation', 'unmapped_hue', 'unmapped_saturation', 'color', 'hsv', 'set_colortemperature', 'colortemperature', 'color_mode', 'supported_color_mode', 'fullcolorsupport', 'mapped', 'switch_state', 'switch_mode', 'switch_toggle', 'power', 'energy', 'voltage', 'humidity', 'alert_state', 'blind_mode', 'endpositionsset', 'statistics_temp', 'statistics_hum', 'statistics_voltage', 'statistics_power', 'statistics_energy']
...
AHA_RW_ATTRIBUTES = ['target_temperature', 'window_open', 'hkr_boost', 'hkr_mode_str', 'hkr_mode', 'simpleonoff', 'level', 'levelpercentage', 'hue', 'saturation', 'unmapped_hue', 'unmapped_saturation', 'color', 'hsv', 'colortemperature', 'switch_state']
...
FRITZ_DEVICE_ATTRIBUTES = ['uptime', 'serial_number', 'software_version', 'hardware_version', 'manufacturer', 'product_class', 'manufacturer_oui', 'model_name', 'description', 'device_log', 'security_port', 'reboot']
HOST_ATTRIBUTES = ['host_info']
HOSTS_ATTRIBUTES = ['hosts_count', 'hosts_info', 'mesh_topology', 'number_of_hosts', 'hosts_url', 'mesh_url']
HOST_ATTRIBUTES_CHILD = ['network_device', 'device_ip', 'device_connection_type', 'device_hostname', 'connection_status', 'is_host_active']

...
AHA_RW_ATTRIBUTES = ['target_temperature', 'window_open', 'hkr_boost', 'switch_state', 'simpleonoff', 'level', 'levelpercentage', 'hue', 'saturation', 'colortemperature', 'unmapped_hue', 'unmapped_saturation']

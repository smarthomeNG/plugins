...
ALL_ATTRIBUTES_WRITEABLE = ['reboot', 'set_target_temperature', 'set_window_open', 'set_hkr_boost', 'set_simpleonoff', 'set_level', 'set_levelpercentage', 'set_hue', 'set_saturation', 'set_colortemperature', 'switch_toggle', 'tam', 'wlanconfig', 'wps_active', 'deflection_enable', 'aha_device', 'target_temperature', 'window_open', 'hkr_boost', 'hkr_mode', 'simpleonoff', 'level', 'levelpercentage', 'hue', 'saturation', 'unmapped_hue', 'unmapped_saturation', 'color', 'hsv', 'colortemperature', 'switch_state']
...
AHA_RW_ATTRIBUTES = ['target_temperature', 'window_open', 'hkr_boost', 'hkr_mode', 'simpleonoff', 'level', 'levelpercentage', 'hue', 'saturation', 'unmapped_hue', 'unmapped_saturation', 'color', 'hsv', 'colortemperature', 'switch_state']

...
AVM_DATA_TYPES = {
    ...
    'aha': {
      ...
      'hkr_mode_str':                 {'interface': 'aha',          'group': 'hkr',             'sub_group': None,                 'access': 'rw',  'type': 'str',   'deprecated': False,  'supported_by_repeater': False,   'description': 'HKR Modus (on, comfort, standby, eco, frost, off) (Status und Setzen)'},
      'hkr_mode':                     {'interface': 'aha',          'group': 'hkr',             'sub_group': None,                 'access': 'rw',  'type': 'int',   'deprecated': False,  'supported_by_repeater': False,   'description': 'HKR Modus (0-on, 1-comfort, 2-standby, 3-eco, 4-frost, 5-off) (Status und Setzen)'},
      ...
      'unmapped_hue':                 {'interface': 'aha',          'group': 'color',           'sub_group': None,                 'access': 'rw',  'type': 'num ',  'deprecated': False,  'supported_by_repeater': False,   'description': 'Hue (unmapped) (Status und Setzen)'},
      'unmapped_saturation':          {'interface': 'aha',          'group': 'color',           'sub_group': None,                 'access': 'rw',  'type': 'num ',  'deprecated': False,  'supported_by_repeater': False,   'description': 'Saturation (unmapped)  (Status und Setzen)'},

...
AVM_DATA_TYPES = {
    ...
    'aha': {
      ...
      'hsv':                          {'interface': 'aha',          'group': 'color',           'sub_group': None,                 'access': 'rw',  'type': 'list ', 'deprecated': False,  'supported_by_repeater': False,   'description': 'Farbwerte und Helligkeit als Liste [Hue, Saturation, Level in Prozent] (Status und Setzen)'},

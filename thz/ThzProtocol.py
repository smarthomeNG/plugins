...
OpModeHC = {'01': 'normal', '02': 'setback', '03': 'standby', '04': 'restart', '05': 'restart'}
...
MsgTemplate = {
    ...
    'sTimeDate': {'cmd1': 'FC', 'params': {'time': [1, 3, decodeTime, 1], 'date': [4, 3, decodeDate, 1]}},
    'sFirmware': {'cmd1': 'FD', 'params': {'version': [0, 2, decodeShort, 0.01]}},
    'sProdDate': {'cmd1': 'FE', 'params': {'prodDate': [16, 11, decodeString, 1]}},
    ...
    'sFan': {'cmd1': 'F6', 'params': {'fanStage': [4, 1, decodeByte, 1]}},
    'sIcons': {
        'cmd1': '0A0176',
        'params': {
    ...
    'sFlowRateHC1': {'cmd1': '0A033B', 'params': {'flowRateHC1': [0, 2, decodeShort, 0.1]}},
    'sSoftwareID': {'cmd1': '0A024B', 'params': {'softwareID': [0, 2, decodeShort, 1]}},
    'sBoostDHWTotal': {'cmd1': '0A0924', 'cmd2': '0A0925', 'params': {'boostDHWTotal': [0, 2, decodeShort, 1]}},
    'sBoostHCTotal': {'cmd1': '0A0928', 'cmd2': '0A0929', 'params': {'boostHCTotal': [0, 2, decodeShort, 1]}},
    'sHeatRecoveredDay': {
        'cmd1': '0A03AE',
        'cmd2': '0A03AF',
        'params': {'heatRecoveredDay': [0, 2, decodeShort, 0.001]},
    },
    'sHeatRecoveredTotal': {
        'cmd1': '0A03B0',
        'cmd2': '0A03B1',
        'params': {'heatRecoveredTotal': [0, 2, decodeShort, 1]},
    },
    'sHeatDHWDay': {'cmd1': '0A092A', 'cmd2': '0A092B', 'params': {'heatDHWDay': [0, 2, decodeShort, 0.001]}},
    'sHeatDHWTotal': {'cmd1': '0A092C', 'cmd2': '0A092D', 'params': {'heatDHWTotal': [0, 2, decodeShort, 1]}},
    'sHeatHCDay': {'cmd1': '0A092E', 'cmd2': '0A092F', 'params': {'heatHCDay': [0, 2, decodeShort, 0.001]}},
    'sHeatHCTotal': {'cmd1': '0A0930', 'cmd2': '0A0931', 'params': {'heatHCTotal': [0, 2, decodeShort, 1]}},
    'sEPowerDHWDay': {'cmd1': '0A091A', 'cmd2': '0A091B', 'params': {'ePowerDHWDay': [0, 2, decodeShort, 0.001]}},
    'sEPowerDHWTotal': {'cmd1': '0A091C', 'cmd2': '0A091D', 'params': {'ePowerDHWTotal': [0, 2, decodeShort, 1]}},
    'sEPowerHCDay': {'cmd1': '0A091E', 'cmd2': '0A091F', 'params': {'ePowerHCDay': [0, 2, decodeShort, 0.001]}},
    'sEPowerHCTotal': {'cmd1': '0A0920', 'cmd2': '0A0921', 'params': {'ePowerHCTotal': [0, 2, decodeShort, 1]}},
    # read/write messages and parameters
    'pOpMode': {'cmd1': '0A0112', 'rw': 1, 'params': {'pOpMode': [0, 1, decodeOpMode, 1, 0, 14]}},
    'p01RoomTempDayHC1': {'cmd1': '0B0005', 'rw': 1, 'params': {'p01RoomTempDayHC1': [0, 2, decodeShort, 0.1, 10, 30]}},
    'p02RoomTempNightHC1': {
        'cmd1': '0B0008',
        'rw': 1,
        'params': {'p02RoomTempNightHC1': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p03RoomTempStandbyHC1': {
        'cmd1': '0B013D',
        'rw': 1,
        'params': {'p03RoomTempStandbyHC1': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p01RoomTempDayHC1SummerMode': {
        'cmd1': '0B0569',
        'rw': 1,
        'params': {'p01RoomTempDayHC1SummerMode': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p02RoomTempNightHC1SummerMode': {
        'cmd1': '0B056B',
        'rw': 1,
        'params': {'p02RoomTempNightHC1SummerMode': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p03RoomTempStandbyHC1SummerMode': {
        'cmd1': '0B056A',
        'rw': 1,
        'params': {'p03RoomTempStandbyHC1SummerMode': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p13GradientHC1': {'cmd1': '0B010E', 'rw': 1, 'params': {'p13GradientHC1': [0, 2, decodeShort, 0.01, 0, 5]}},
    'p14LowEndHC1': {'cmd1': '0B059E', 'rw': 1, 'params': {'p14LowEndHC1': [0, 2, decodeShort, 0.1, 0, 20]}},
    'p15RoomInfluenceHC1': {
        'cmd1': '0B010F',
        'rw': 1,
        'params': {'p15RoomInfluenceHC1': [0, 2, decodeShort, 1, 0, 100]},
    },
    'p19FlowProportionHC1': {
        'cmd1': '0B059D',
        'rw': 1,
        'params': {'p19FlowProportionHC1': [0, 2, decodeShort, 1, 0, 100]},
    },
    'p01RoomTempDayHC2': {'cmd1': '0C0005', 'rw': 1, 'params': {'p01RoomTempDayHC2': [0, 2, decodeShort, 0.1, 10, 30]}},
    'p02RoomTempNightHC2': {
        'cmd1': '0C0008',
        'rw': 1,
        'params': {'p02RoomTempNightHC2': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p03RoomTempStandbyHC2': {
        'cmd1': '0C013D',
        'rw': 1,
        'params': {'p03RoomTempStandbyHC2': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p01RoomTempDayHC2SummerMode': {
        'cmd1': '0C0569',
        'rw': 1,
        'params': {'p01RoomTempDayHC2SummerMode': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p02RoomTempNightHC2SummerMode': {
        'cmd1': '0C056B',
        'rw': 1,
        'params': {'p02RoomTempNightHC2SummerMode': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p03RoomTempStandbyHC2SummerMode': {
        'cmd1': '0C056A',
        'rw': 1,
        'params': {'p03RoomTempStandbyHC2SummerMode': [0, 2, decodeShort, 0.1, 10, 30]},
    },
    'p16GradientHC2': {'cmd1': '0C010E', 'rw': 1, 'params': {'p16GradientHC2': [0, 2, decodeShort, 0.01, 0, 5]}},
    'p17LowEndHC2': {'cmd1': '0C059E', 'rw': 1, 'params': {'p17LowEndHC2': [0, 2, decodeShort, 0.1, 0, 20]}},
    'p18RoomInfluenceHC2': {
        'cmd1': '0C010F',
        'rw': 1,
        'params': {'p18RoomInfluenceHC2': [0, 2, decodeShort, 1, 0, 100]},
    },
    'p04DHWsetDayTemp': {'cmd1': '0A0013', 'rw': 1, 'params': {'p04DHWsetDayTemp': [0, 2, decodeShort, 0.1, 10, 55]}},
    'p05DHWsetNightTemp': {
        'cmd1': '0A05BF',
        'rw': 1,
        'params': {'p05DHWsetNightTemp': [0, 2, decodeShort, 0.1, 10, 55]},
    },
    'p83DHWsetSolarTemp': {
        'cmd1': '0A05BE',
        'rw': 1,
        'params': {'p83DHWsetSolarTemp': [0, 2, decodeShort, 0.1, 10, 65]},
    },
    'p06DHWsetStandbyTemp': {
        'cmd1': '0A0581',
        'rw': 1,
        'params': {'p06DHWsetStandbyTemp': [0, 2, decodeShort, 0.1, 10, 55]},
    },
    'p11DHWsetManualTemp': {
        'cmd1': '0A0580',
        'rw': 1,
        'params': {'p11DHWsetManualTemp': [0, 2, decodeShort, 0.1, 10, 55]},
    },
    'p07FanStageDay': {'cmd1': '0A056C', 'rw': 1, 'params': {'p07FanStageDay': [0, 2, decodeShort, 1, 0, 3]}},
    'p08FanStageNight': {'cmd1': '0A056D', 'rw': 1, 'params': {'p08FanStageNight': [0, 2, decodeShort, 1, 0, 3]}},
    'p09FanStageStandby': {'cmd1': '0A056F', 'rw': 1, 'params': {'p09FanStageStandby': [0, 2, decodeShort, 1, 0, 3]}},
    'p99FanStageParty': {'cmd1': '0A0570', 'rw': 1, 'params': {'p99FanStageParty': [0, 2, decodeShort, 1, 0, 3]}},
    'p75passiveCooling': {'cmd1': '0A0575', 'rw': 1, 'params': {'p75passiveCooling': [0, 2, decodeShort, 1, 0, 4]}},
    'p21Hyst1': {'cmd1': '0A05C0', 'rw': 1, 'params': {'p21Hyst1': [0, 2, decodeShort, 0.1, 0, 10]}},
    'p22Hyst2': {'cmd1': '0A05C1', 'rw': 1, 'params': {'p22Hyst2': [0, 2, decodeShort, 0.1, 0, 10]}},
    'p23Hyst3': {'cmd1': '0A05C2', 'rw': 1, 'params': {'p23Hyst3': [0, 2, decodeShort, 0.1, 0, 5]}},
    'p24Hyst4': {'cmd1': '0A05C3', 'rw': 1, 'params': {'p24Hyst4': [0, 2, decodeShort, 0.1, 0, 5]}},
    'p25Hyst5': {'cmd1': '0A05C4', 'rw': 1, 'params': {'p25Hyst5': [0, 2, decodeShort, 0.1, 0, 5]}},
    'p29HystAsymmetry': {'cmd1': '0A05C5', 'rw': 1, 'params': {'p29HystAsymmetry': [0, 2, decodeShort, 1, 1, 5]}},
    'p30integralComponent': {
        'cmd1': '0A0162',
        'rw': 1,
        'params': {'p30integralComponent': [0, 2, decodeShort, 1, 10, 999]},
    },
    'p32hystDHW': {'cmd1': '0A0140', 'rw': 1, 'params': {'p32hystDHW': [0, 2, decodeShort, 1, 0, 10]}},
    'p33BoosterTimeoutDHW': {
        'cmd1': '0A0588',
        'rw': 1,
        'params': {'p33BoosterTimeoutDHW': [0, 2, decodeShort, 1, 0, 200]},
    },
    'p79BoosterTimeoutHC': {
        'cmd1': '0A05A0',
        'rw': 1,
        'params': {'p79BoosterTimeoutHC': [0, 2, decodeShort, 1, 0, 240]},
    },
    'p46UnschedVent0': {'cmd1': '0A0571', 'rw': 1, 'params': {'p46UnschedVent0': [0, 2, decodeShort, 1, 0, 900]}},
    'p45UnschedVent1': {'cmd1': '0A0572', 'rw': 1, 'params': {'p45UnschedVent1': [0, 2, decodeShort, 1, 0, 900]}},
    'p44UnschedVent2': {'cmd1': '0A0573', 'rw': 1, 'params': {'p44UnschedVent2': [0, 2, decodeShort, 1, 0, 900]}},
    'p43UnschedVent3': {'cmd1': '0A0574', 'rw': 1, 'params': {'p43UnschedVent3': [0, 2, decodeShort, 1, 0, 900]}},
    #  'p99UnschedVentStage': {
    #    'cmd1': '0A05DD', 'rw': 1,
    #    'params': {
    ...
    #      }
    #  },
    'p37FanStage1AirIn': {'cmd1': '0A0576', 'rw': 1, 'params': {'p37FanStage1AirIn': [0, 2, decodeShort, 1, 50, 300]}},
    'p38FanStage2AirIn': {'cmd1': '0A0577', 'rw': 1, 'params': {'p38FanStage2AirIn': [0, 2, decodeShort, 1, 50, 300]}},
    'p39FanStage3AirIn': {'cmd1': '0A0578', 'rw': 1, 'params': {'p39FanStage3AirIn': [0, 2, decodeShort, 1, 50, 300]}},
    'p40FanStage1AirOut': {
        'cmd1': '0A0579',
        'rw': 1,
        'params': {'p40FanStage1AirOut': [0, 2, decodeShort, 1, 50, 300]},
    },
    'p41FanStage2AirOut': {
        'cmd1': '0A057A',
        'rw': 1,
        'params': {'p41FanStage2AirOut': [0, 2, decodeShort, 1, 50, 300]},
    },
    'p42FanStage3AirOut': {
        'cmd1': '0A057B',
        'rw': 1,
        'params': {'p42FanStage3AirOut': [0, 2, decodeShort, 1, 50, 300]},
    },
    'p49SummerModeTemp': {'cmd1': '0A0116', 'rw': 1, 'params': {'p49SummerModeTemp': [0, 2, decodeShort, 0.1, 10, 25]}},
    'p50SummerModeHysteresis': {
        'cmd1': '0A05A2',
        'rw': 1,
        'params': {'p50SummerModeHysteresis': [0, 2, decodeShort, 0.1, 0.5, 5]},
    },
    'p78DualModePoint': {'cmd1': '0A01AC', 'rw': 1, 'params': {'p78DualModePoint': [0, 2, decodeShort, 0.1, -10, 20]}},
    'p54MinPumpCycles': {'cmd1': '0A05B8', 'rw': 1, 'params': {'p54MinPumpCycles': [0, 2, decodeShort, 1, 1, 24]}},
    'p55MaxPumpCycles': {'cmd1': '0A05B7', 'rw': 1, 'params': {'p55MaxPumpCycles': [0, 2, decodeShort, 1, 25, 200]}},
    'p56OutTempMaxPumpCycles': {
        'cmd1': '0A05B9',
        'rw': 1,
        'params': {'p56OutTempMaxPumpCycles': [0, 2, decodeShort, 0.1, 0, 20]},
    },
    'p57OutTempMinPumpCycles': {
        'cmd1': '0A05BA',
        'rw': 1,
        'params': {'p57OutTempMinPumpCycles': [0, 2, decodeShort, 0.1, 0, 25]},
    },
    'p76RoomThermCorrection': {
        'cmd1': '0A0109',
        'rw': 1,
        'params': {'p76RoomThermCorrection': [0, 2, decodeShort, 0.000390625, -5, 5]},
    },
    'p77OutThermFilterTime': {
        'cmd1': '0A010C',
        'rw': 1,
        'params': {'p77OutThermFilterTime': [0, 2, decodeShort, 1, 1, 24]},
    },
    'p35PasteurisationInterval': {
        'cmd1': '0A0586',
        'rw': 1,
        'params': {'p35PasteurisationInterval': [0, 2, decodeShort, 1, 1, 30]},
    },
    'p35PasteurisationTemp': {
        'cmd1': '0A0587',
        'rw': 1,
        'params': {'p35PasteurisationTemp': [0, 2, decodeShort, 0.1, 10, 65]},
    },
    'p34BoosterDHWTempAct': {
        'cmd1': '0A0589',
        'rw': 1,
        'params': {'p34BoosterDHWTempAct': [0, 2, decodeShort, 0.1, -10, 10]},
    },
    'p99DHWmaxFlowTemp': {'cmd1': '0A058C', 'rw': 1, 'params': {'p99DHWmaxFlowTemp': [0, 2, decodeShort, 0.1, 10, 75]}},
    'p89DHWeco': {'cmd1': '0A058D', 'rw': 1, 'params': {'p89DHWeco': [0, 2, decodeShort, 1, 0, 1]}},
    'p99startUnschedVent': {'cmd1': '0A05DD', 'rw': 1, 'params': {'p99startUnschedVent': [0, 2, decodeShort, 1, 0, 3]}},
    'p99CoolingSwitch': {'cmd1': '0B0287', 'rw': 1, 'params': {'p99CoolingSwitch': [0, 2, decodeShort, 1, 0, 1]}},
    'pClockDay': {'cmd1': '0A0122', 'rw': 1, 'params': {'pClockDay': [0, 2, decodeShort, 1, 1, 31]}},
    'pClockMonth': {'cmd1': '0A0123', 'rw': 1, 'params': {'pClockMonth': [0, 2, decodeShort, 1, 1, 12]}},
    'pClockYear': {'cmd1': '0A0124', 'rw': 1, 'params': {'pClockYear': [0, 2, decodeShort, 1, 12, 20]}},
    'pClockHour': {'cmd1': '0A0125', 'rw': 1, 'params': {'pClockHour': [0, 2, decodeShort, 1, 0, 23]}},
    'pClockMinute': {'cmd1': '0A0126', 'rw': 1, 'params': {'pClockMinute': [0, 2, decodeShort, 1, 0, 59]}},
}
...
VersionSpecificMsgData = {
    ...
    '4.39': {'ap': ['sGlobal', 'actualPower_Qc', [45, 4, decodeFloat, 1]]},
    ...
    def __init__(self, serial_port, baudrate, logger):
        ...
        if self._portHandler.isPortOpen():
            ...
            if msg is not None:
                ...
                self.logger.warning(
                    'thz: The messages could not be adjusted to the heat pump version due to missing heat pump response.'
                )

        else:
            self.logger.warning(
                'thz: The messages could not be adjusted to the heat pump version due to com port failure.'
            )
        ...
        if data[0] == 0x15:
            ...
            for key in MsgTemplate[name]['params'].keys():
                ...
                try:
                    ...
                    self.logger.warning(
                        'Message {} too short (length = {}, index = {})'.format(name, len(payload), item[0])
                    )
            return msg
        return None
            ...
            try:
                ...
                if param == 'pOpMode':
                    ...
                    if value in self._opModeInv:
                        ...
                        return
                if value < tmpl['params'][param][4] or value > tmpl['params'][param][5]:
                    self.logger.warning(
                        'Parameter value out of range - {}={}, [{}:{}]'.format(
                            param, value, tmpl['params'][param][4], tmpl['params'][param][5]
                        )
                    )
                else:
                    # value OK
                    ...
                    if not (data[0] == 0x01 and data[1] == 0x80):
                        self.logger.warning(
                            'Set request failed - {}: {}'.format(param, ' '.join(format(x, '02x') for x in data))
                        )
                        self._rxNackCount += 1
            except Exception:
            ...
            for name in request:
                ...
                if msg1 is not None:
                    ...
                    if noResponseCount > 10:
                        ...
                        self.logger.debug(
                            'Status: isPortOpen: {}, request: {}, portErrorCount: {}, name: {}'.format(
                                self._portHandler.isPortOpen(), request, self._portErrorCount, name
                            )
                        )

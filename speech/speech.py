...
varDimmwert = [[100, ['100', 'ganz hell', 'voll']], [70, ['70', 'hey', 'hell']], [5, ['5', 'dunkel', 'gemütlich']]]
...
varZahl = [
    ...
    [33, ['33']],
    [34, ['34']],
    [45, ['45', 'fünfundvierzigfuenfundvierzieg']],
    [46, ['46']],
    [47, ['47']],
    [48, ['48']],
    [49, ['49']],
...
varLicht = [['beleuchtung', ['licht', 'lampe', 'beleuchtung', 'leuchte', 'liegt']]]

varGeschoss = [['eg', ['erdgeschoss', 'eg', 'parterre']], ['dg', ['dachgeschoss', 'dg', 'obergeschoss', 'og']]]

varStopp = [[1, ['gestoppt', 'stop', 'anhalten', 'stock', 'stadt', 'stoff', 'stock']]]

varTemperatur = [['%status%', ['temperatur', 'lufttemperatur', 'raumtemperatur', 'warm', 'kalt']]]

varSzene = [['eg.szenen.kueche_essen_wohnen', ['beleuchtungsszene', 'szenen', 'szene', 'lichtstimmung']]]

varSzeneValue = [[9, ['fernsehen']], [10, ['essen']], [11, ['kochen']], [12, ['party']], [13, ['alles aus']]]
...
varParse = [
    ...
    [
        '%2%.rollladen.%1%.stopp',
        '%3%',
        [varRollladen, varRichtung, varRaum, varStopp],
        'OK, Rollladen %1% im %2% gestoppt.',
    ],
    [
        '%0%.rollladen.%2%.stopp',
        '%3%',
        [varRaum, varRollladen, varRichtung, varStopp],
        'OK, Rollladen %2% im %0% gestoppt.',
    ],
    [
        '%1%.rollladen.%2%.stopp',
        '%3%',
        [varRollladen, varRaum, varRichtung, varStopp],
        'OK, Rollladen %2% im %1% gestoppt.',
    ],
    [
        '%0%.rollladen.%1%.stopp',
        '%3%',
        [varRaum, varRichtung, varRollladen, varStopp],
        'OK, Rollladen %1% im %0% gestoppt.',
    ],
    [
        '%2%.rollladen.%1%.position',
        '%3%',
        [varRollladen, varRichtung, varRaum, varZahl],
        'OK, fahre den Rollladen %1% im %2% auf %3% Prozent.',
    ],
    [
        '%0%.rollladen.%2%.position',
        '%3%',
        [varRaum, varRollladen, varRichtung, varZahl],
        'OK, fahre den Rollladen %2% im %0% auf %3% Prozent.',
    ],
    [
        '%1%.rollladen.%2%.position',
        '%3%',
        [varRollladen, varRaum, varRichtung, varZahl],
        'OK, fahre den Rollladen %2% im %1% auf %3% Prozent.',
    ],
    [
        '%0%.rollladen.%1%.position',
        '%3%',
        [varRaum, varRichtung, varRollladen, varZahl],
        'OK, fahre den Rollladen %1% im %0% auf %3% Prozent.',
    ],
    [
        '%2%.rollladen.%1%.position',
        '%3%',
        [varRollladen, varRichtung, varRaum, varFahren],
        'OK, Rollladen %1% im %2% %3%.',
    ],
    [
        '%0%.rollladen.%2%.position',
        '%3%',
        [varRaum, varRollladen, varRichtung, varFahren],
        'OK, Rollladen %2% im %0% %3%.',
    ],
    [
        '%1%.rollladen.%2%.position',
        '%3%',
        [varRollladen, varRaum, varRichtung, varFahren],
        'OK, Rollladen %2% im %1% %3%.',
    ],
    [
        '%0%.rollladen.%1%.position',
        '%3%',
        [varRaum, varRichtung, varRollladen, varFahren],
        'OK, Rollladen %1% im %0% %3%.',
    ],
    ...
    [
        '%1%.rollladen.position',
        '%2%',
        [varRollladen, varRaum, varZahl, 'Prozent'],
        'OK, fahre den Rollladen im %1% auf %2% Prozent.',
    ],
    [
        '%0%.rollladen.position',
        '%2%',
        [varRaum, varRollladen, varZahl, 'Prozent'],
        'OK, fahre den Rollladen im %0% auf %2% Prozent.',
    ],

...
class WebInterface(SmartPluginWebIf):
    ...
    @cherrypy.expose
    def index(self, reload=None, learn=None):
        """
    ...
    def set_port_enabled(self, port, status):
        return self.plugin.set_port_enabled(port, status)

    @cherrypy.expose
    def set_port_poe(self, port, status):
        return self.plugin.set_port_poe(port, status)

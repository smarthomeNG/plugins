...
def set_percentage(self, payload):
    ...
    for item in items:
        ...
        self.logger.debug("Alexa: setPercentage({}, {0:.1f})".format(item.id(), item_new))
        item( item_new )
...
def incr_percentage(self, payload):
    ...
    for item in items:
        ...
        self.logger.debug("Alexa: incrementPercentage({}, {0:.1f})".format(item.id(), item_new))
        item( item_new )
...
def decr_percentage(self, payload):
    ...
    for item in items:
        ...
        self.logger.debug("Alexa: decrementPercentage({}, {0:.1f})".format(item.id(), item_new))
        item( item_new )

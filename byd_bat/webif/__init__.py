...
class WebInterface(SmartPluginWebIf):
    ...
    def get_data_html(self, dataSet=None):
        ...
        t = (
            t
            + '<tr><td class="py-1"><strong>SOC:</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_soc:.1f}'
            + ' %'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>SOH:</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_soh:.1f}'
            + ' %'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Leistung')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_power:.1f}'
            + ' W'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Ladeleistung')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_power_charge:.1f}'
            + ' W'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Entladeleistung')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_power_discharge:.1f}'
            + ' W'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Spannung Ausgang')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_volt_out:.1f}'
            + ' V'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Strom Ausgang')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_current:.1f}'
            + ' A'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Spannung Batterie')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_volt_bat:.1f}'
            + ' V'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Spannung Batteriezellen max')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_volt_max:.3f}'
            + ' V'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Spannung Batteriezellen min')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_volt_min:.3f}'
            + ' V'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Spannung Batteriezellen Differenz')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_volt_diff * 1000:.1f}'
            + ' mV'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Temperatur Batterie')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_temp_bat:.1f}'
            + ' °C'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Temperatur Batterie max')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_temp_max:.1f}'
            + ' °C'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Temperatur Batterie min')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_temp_min:.1f}'
            + ' °C'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Laden total')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_charge_total:.1f}'
            + ' kWh'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Entladen total')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_discharge_total:.1f}'
            + ' kWh'
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Wirkungsgrad')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + f'{self.plugin.byd_eta:.1f}'
            + ' %'
            + '</td>'
            + '</tr>'
        )
        ...
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Batterietyp')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + self.plugin.byd_batt_str
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Seriennummer')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + self.plugin.byd_serial
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Türme')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + str(self.plugin.byd_bms_qty)
            + '</td>'
            + '</tr>'
        )
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Module pro Turm')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + str(self.plugin.byd_modules)
            + '</td>'
            + '</tr>'
        )
        t = (
        ...
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Fehler')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + self.plugin.byd_error_str
            + ' ('
            + str(self.plugin.byd_error_nr)
            + ')'
            + '</td>'
            + '</tr>'
        )
        ...
        t = (
            t
            + '<tr><td class="py-1"><strong>'
            + self.translate('Parameter-Tabelle')
            + ':</strong></td>'
            + '<td class="py-1" style="text-align: right">'
            + self.plugin.byd_param_t
            + '</td>'
            + '</tr>'
        )
        t = t + '</tbody></table>'
        ...
        for xx in range(1, self.plugin.byd_towers_max + 1):
            ...
            if xx <= self.plugin.byd_bms_qty:
                ...
                ts.append(
                    [
                        self.translate('Spannung max (Zelle)'),
                        f'{self.plugin.byd_diag_volt_max[xx]:.3f}'
                        + ' V ('
                        + str(self.plugin.byd_diag_volt_max_c[xx])
                        + ')',
                    ]
                )
                ts.append(
                    [
                        self.translate('Spannung min (Zelle)'),
                        f'{self.plugin.byd_diag_volt_min[xx]:.3f}'
                        + ' V ('
                        + str(self.plugin.byd_diag_volt_min_c[xx])
                        + ')',
                    ]
                )
                ...
                ts.append(
                    [
                        self.translate('Temperatur max (Zelle)'),
                        f'{self.plugin.byd_diag_temp_max[xx]:.1f}'
                        + ' V ('
                        + str(self.plugin.byd_diag_temp_max_c[xx])
                        + ')',
                    ]
                )
                ts.append(
                    [
                        self.translate('Temperatur min (Zelle)'),
                        f'{self.plugin.byd_diag_temp_min[xx]:.1f}'
                        + ' V ('
                        + str(self.plugin.byd_diag_temp_min_c[xx])
                        + ')',
                    ]
                )
                ts.append([self.translate('Laden total'), f'{self.plugin.byd_diag_charge_total[xx]:.3f}' + ' kWh'])
                ts.append(
                    [self.translate('Entladen total'), f'{self.plugin.byd_diag_discharge_total[xx]:.3f}' + ' kWh']
                )
        ...
        t = (
            ...
            + self.plugin.byd_diag_state_str[1]
            + ' (0x'
            + f'{self.plugin.byd_diag_state[1]:04x}'
            + ')</p>'
        )
        if self.plugin.byd_bms_qty > 1:
            t = t + '<p></p>'
            ...
            t = (
                ...
                + self.plugin.byd_diag_state_str[2]
                + ' (0x'
                + f'{self.plugin.byd_diag_state[2]:04x}'
                + ')</p>'
            )
            if self.plugin.byd_bms_qty > 2:
                t = t + '<p></p>'
                ...
                t = (
                    ...
                    + self.plugin.byd_diag_state_str[3]
                    + ' (0x'
                    + f'{self.plugin.byd_diag_state[3]:04x}'
                    + ')</p>'
                )
        data['r4_table'] = t
    ...
    def table_diag_details(self, xx):
        ...
        t = t + self.table_diag_details_row(
            self.translate('Spannung minimal') + ' [V]', xx, self.plugin.byd_module_vmin, 3
        )
        t = t + self.table_diag_details_row(
            self.translate('Spannung maximal') + ' [V]', xx, self.plugin.byd_module_vmax, 3
        )
        t = t + self.table_diag_details_row(
            self.translate('Spannung Durchschnitt') + ' [V]', xx, self.plugin.byd_module_vava, 3
        )
        t = t + self.table_diag_details_row(
            self.translate('Spannung Differenz') + ' [mV]', xx, self.plugin.byd_module_vdif, 0
        )
        t = t + '</tbody></table>'
        return t
        ...
        for i in range(0, self.plugin.byd_modules):
            if nn == 1:
                t = (
                    ...
                    + f'{self.plugin.byd_diag_module[xx][i][vi]:.1f}'
                    + '</td>'
                )
            elif nn == 2:
                t = (
                    t
                    + '<td class="py-1" style="text-align: center">'
                    + f'{self.plugin.byd_diag_module[xx][i][vi]:.2f}'
                    + '</td>'
                )
            elif nn == 3:
                t = (
                    t
                    + '<td class="py-1" style="text-align: center">'
                    + f'{self.plugin.byd_diag_module[xx][i][vi]:.3f}'
                    + '</td>'
                )
            else:
                t = (
                    t
                    + '<td class="py-1" style="text-align: center">'
                    + f'{self.plugin.byd_diag_module[xx][i][vi]:.0f}'
                    + '</td>'
                )
        t = t + '</tr>'
        return t
